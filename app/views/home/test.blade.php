			...
			<div class="row">
				<div class="col-md-4">
					<div class="Financial-box">
						...
						<a href="{{route('home_path')}}" class="green-btn">Know more</a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="Financial-box">
						<img src="../images/logo-blue.png">
						<h3>Financial Importance</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<a href="{{route('blue_path')}}" class="green-btn">Know more</a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="Financial-box">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<a href="{{route('red_path')}}" class="green-btn">Know more</a>
					</div>
				</div>
			</div>
		</div>
