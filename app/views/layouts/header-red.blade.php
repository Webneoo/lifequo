	...
	<nav id="nav-menu" class="navbar navbar-default navbar-fixed-top">
    	...
    	<!-- Brand and toggle get grouped for better mobile display -->
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand hidden-lg hidden-md hidden-xs" href="{{ route('red_path') }}"><img src="../images/logo-red.png" alt="LifeQuo Logo" height="30"></a>
		      <a href="{{ route('home_path') }}" class="green hidden-lg"></a>
		      <a href="{{ route('blue_path') }}" class="blue hidden-lg"></a>
